...
for train_index, test_index in skf.split(X,y):
    ...
    X_train, X_test = feedESN(feature_matrix[train_index], N, M, Mb, scale, mem, sigmoid_exponent), feedESN(feature_matrix[test_index], N, M, Mb, scale, mem, sigmoid_exponent)
